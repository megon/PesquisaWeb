...
Funcionalidade: Responder primeiro passo da pesquisa
  ...
  Esquema do Cenario: Preencher todas as questoes obrigatorias do primeiro passo da pesquisa.
    ...
    E o DDD residencial com "<ddd_residencial>"
    ...
    E clicar no botao "Ir para o próximo passo"
    Entao devo ser redirecionado para a proxima pagina da pesquisa
  
    Exemplos:
    |endereco    |numero|bairro         |cidade   |estado|ddd_residencial|telefone_residencial|resposta_atualmente_esta|resposta_tem_filhos|resposta_quantos_filhos|resposta_sexo_filho|resposta_data_nascimento_filho|resposta_mora_com_voce|resposta_grau_instrucao|resposta_estuda_momento|
    |carlos weber|7900  |Vila Leopoldina|São Paulo|SP    |11             |12341234            |solteiro                |sim                |1                      |masculino          |30/09/2009                    |sim                   |Pós-graduação          |nao                    |
